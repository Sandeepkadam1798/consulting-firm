    ...
    <>
      <div className="overflow-x-hidden min-h-screen bg-gray-100 py-8 px-4">
        ...
        <div className="max-w-5xl mx-auto bg-white p-8 shadow-lg">
          ...
          >
            <ul>
              <li>{`•	Civil, Structural & Architecture design basis`}</li>
              <li>{`•	Drawings – Layout, foundations, grading, General arrangement `}</li>
              <li>{`•	Design calculations `}</li>
              <li>{`•	Specification & Datasheets`}</li>
              <li>{`•	Reports – Stress analysis, passive fire proofing, 3D model`}</li>
