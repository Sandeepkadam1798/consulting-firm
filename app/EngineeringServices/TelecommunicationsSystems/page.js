        ...
        <div className="max-w-5xl mx-auto bg-white p-8 shadow-lg">
          ...
          >
            <ul>
              ...
              <li>{`•	Microwave Network Design `}</li>
              <li>{`•	Site Acquisition `}</li>
              <li>{`•	Public and Private Broadband Networks assessment`}</li>
              <li>{`•	Two-Way Radio Design and services`}</li>
              <li>{`•	Site Support Telecommunications `}</li>
